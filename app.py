...
client = MongoClient("mongodb+srv://grtom16:SdDfKbr7sw49ZTrs@cluster0.0a52k.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client['db1'] 
...
def enviar_email(destinatario, asunto, cuerpo):
    mensaje = Mail(
        from_email='correoderecuperacion141@gmail.com',  # Cambia esto por tu correo
